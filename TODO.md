...
8. <del>Inhance ctc loss [here](https://github.com/PaddlePaddle/PaddleOCR/blob/release/2.7/doc/doc_en/enhanced_ctc_loss_en.md)
9. DVC for data,  model
10. Serving Deployment(DockerFile, FastAPI)
11. Algorithms in Sequence Modeling