...
class ExportTool:
    def __init__(self, args):
        ...
        self.sample = torch.randn(size=cfg['Train']['dataset']['transforms']['image_shape']).unsqueeze(0)
...
def cli():
    ...
    parser.add_argument("--device", type=str, default='cpu', help="Select device for export format")
