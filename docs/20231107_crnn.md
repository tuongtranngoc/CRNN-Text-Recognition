...
## Transcription Layer
Transcription is to find the label sequence with hightest probability condtional on per-frame predictions (outputs from LSTM model) and remove the repeat labels and blanks
